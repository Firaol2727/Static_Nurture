...
<div id="wrapper" class="clearfix">
 ...
 <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark-4" data-bg-img="images/bg/download9.jpeg">
      <div class="container pt-120 pb-60">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Research Advisory</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="index.php.html">Home</a></li>
                <li><a href="service.php">services</a></li>
                <li class="active">Research Advisory</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored line-bottom text-theme-colored">Research Advisory</h3>
              <p> We Provide advisory, training and research services in all aspects of management (Functional or Strategic), Finance and Accountancy, Governance, Development and Economic Analysis.  

              </p>
              <blockquote class="bg-silver-light">We provides research based business consulting services to people who desire to obtain data about specific topics. We gathers information from credible sources and provides an analysis of his findings. We also interpret the information for clients.</blockquote>
            
              <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Research Based Advisory </h4>
              <div class="row">
                <div class="col-md-6">
                    <div class="mt-20">
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-pie-chart text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Policy Advisory</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-paper-plane text-theme-colored2"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Economic Advisory</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Social Impact Advisory</h5>
                          <p></p>
                        </div>
                      </div>
                    </div>
              ...
              <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Developing Research Based Advisory</h4>
              <ul id="myTab" class="nav nav-tabs boot-tabs">
                <li class="active"><a href="#small" data-toggle="tab">Feasibility Studies</a></li>
                <li><a href="#medium" data-toggle="tab">Trend Analysis and Forecasting</a></li>
                <li><a href="#large" data-toggle="tab">Develop and Implement recommendations</a></li>
              </ul>
              <div id="myTabContent" class="tab-content bg-silver-light">
                <div class="tab-pane fade in active" id="small">
                  <div class="row">
                    <div class="col-md-7">
                      <h3 class="mt-0 text-theme-colored">Feasibility <span class="text-theme-colored2">Studies</span></h3>
                      <p class="">Conducting feasibility studies to assess the viability and potential success of specific projects, ventures, or initiatives.
                         This involves evaluating market conditions,
                         financial projections, operational considerations, and risk assessment to help clients make informed investment decisions.</p>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="tab-pane fade" id="medium">
                  <div class="mt-20">
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Collect and Analyze Data</h5>
                        <p>
                          Implement the chosen research methodology to collect data from reliable and relevant sources.
                           Ensure that the data collection process is ethical and rigorous. 
                          Analyze and interpret the collected data using appropriate analytical techniques and tools.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0"> Generate Findings</h5>
                        <p>
                          Based on the data analysis, generate research findings that answer the research questions. Identify patterns, trends, correlations,
                           or insights that emerge from the data. Use visual representations, charts, or graphs to present the findings effectively
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade" id="large">
                  <div class="mt-20">
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Develop Recommendation</h5>
                        <p> Translate the research findings into actionable recommendations.
                          Consider the implications of the findings and propose strategies, interventions, or solutions to address the identified challenges or capitalize on opportunities. 
                          Select appropriate research methodologies and techniques to address the research questions. Determine the data collection methods, such as surveys, interviews, experiments,
                         or data analysis, and establish a systematic approach to gather relevant information</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0"> Implement Recommendation</h5>
                        <p>
                          Support the implementation of the advisory by providing guidance, resources, or support to stakeholders. Establish a monitoring and evaluation framework to assess the impact and effectiveness of the advisory.
                          Continuously gather feedback, track progress, and make necessary adjustments as required.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="widget">
                ...
                <div class="services-list">
                  <ul class="list list-border">
                     <li><a href="training.php.html">Training</a></li>
                  <li><a href="management.php.html">Management Consultancy</a></li>
                  <li class="active"><a href="research.php.html">Research Based Business</a></li>
                  <li><a href="investment.php.html">Investment Advisory</a></li>
                  </ul>
                </div>
              </div>
