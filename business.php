    ...
    <section class="inner-header divider layer-overlay overlay-dark-4" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Business Consulting</h2>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored line-bottom text-theme-colored">Business Consulting</h3>
              ...
              <blockquote class="bg-silver-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore voluptatem officiis quod animi possimus a, iure nam sunt quas aperiam non recusandae reprehenderit, nesciunt cumque pariatur totam.</blockquote>
              ...
              <div class="widget">
                ...
                <div class="services-list">
                  <ul class="list list-border">
                    <li><a href="financial.php.html">Financial Analysis</a></li>
                    <li><a href="investment-planning.php">Investment Planning</a></li>
                    <li><a href="investment-saving.php">Saving & Investments</a></li>
                    <li><a href="investment-banking.php">Investment Banking</a></li>
                    <li class="active"><a href="business.php.html">Business Consulting</a></li>
                    <li><a href="online.php">Online Consulting</a></li>
                  </ul>
                </div>
              </div>
              <div class="widget">
