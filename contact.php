...
<meta name="description" content="Becoming a center of excellence for nurturing the natural talent of the human mind so as to enable realize the highest level of executive and leadership talent.">
<meta name="keywords" content="consulting,finance,advisor,consultant,business,service,insurance,agency">
<meta name="author" content="ThemeMascot">

<!-- Page Title -->
<title>Contact US| Nurture management Consulting</title>
          ...
          <div class="col-md-8">
            ...
            <!-- Contact Form -->
                <form id="contact_form" name="contact_form" class="" method="post"  >
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input id="subject" name="subject" required name="subject" class="form-control required" type="text" placeholder="Enter Subject">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Phone</label>
                        <input id="phonenumber" name="phonenumber" required class="form-control" type="text" placeholder="Enter Phone">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label>Message</label>
                    <textarea id="message" name="message" class="form-control required" required rows="5" placeholder="Enter Message"></textarea>
                  </div>
                  <div class="form-group">
                    <input name="form_botcheck" class="form-control" type="hidden" value="">
                    <button type="submit" id="submitBtn" class="btn btn-dark btn-theme-colored btn-flat mr-5" data-loading-text="Please wait...">Send your message</button>
                    <button type="reset" onclick="onreset();" class="btn btn-default btn-flat btn-theme-colored">Reset</button>
                  </div>
                </form>
            ...
            <script>
              ...
              function submitForm(event) {
                ...
                xhr.onload = function () {
                  ...
                  if (xhr.status === 200) {
                      alert('Email sent,Thank you for using our service !');
                  } else {
                    // Show error message
