...
<div id="wrapper" class="clearfix">
 ...
 <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark-4" data-bg-img="images/bg/downa.avif">
      <div class="container pt-120 pb-60">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Training</h2>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored line-bottom text-theme-colored">Training</h3>
              ...
              <blockquote class="bg-silver-light">We can’t do business without business skill but business skill is something we can learn and have. So that we provide business skill training to business owners, entrepreneurs and employers in structured and efficient way to ensure our clients have the tools to contributes to the maximum extent possible and get the company on the right track to success.</blockquote>
            
              <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Developing effective Training </h4>
              <div class="row">
                <div class="col-md-6">
                    <div class="mt-20">
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-pie-chart text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Business Training</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-paper-plane text-theme-colored2"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Employee Behavior</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Peer Training</h5>
                          <p></p>
                        </div>
                      </div>
                    </div>
             ...
             <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Developing Training Strategies</h4>
              <ul id="myTab" class="nav nav-tabs boot-tabs">
                <li class="active"><a href="#small" data-toggle="tab">Perform a Need Assessment</a></li>
                <li><a href="#medium" data-toggle="tab">Research and Define Needs </a></li>
                <li><a href="#large" data-toggle="tab">Training Delivery</a></li>
              ...
              <div id="myTabContent" class="tab-content bg-silver-light">
                <div class="tab-pane fade in active" id="small">
                  <div class="row">
                    <div class="col-md-7">
                      <h3 class="mt-0 text-theme-colored">Perform a <span class="text-theme-colored2">Needs</span>, Assessment</h3>
                ...
                <div class="tab-pane fade" id="medium">
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Define the Training Needs</h5>
                        <p>Determine what training is needed and how often the training is required. Sales departments might have regular weekly or monthly training on products and services. Customer services departments could have monthly training on systems. Anyone who deals with personal customer data should also have annual privacy and online security training. </p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="widget">
                ...
                <div class="services-list">
                  <ul class="list list-border">
                     <li class="active"><a href="training.php.html">Training</a></li>
                  <li><a href="management.php.html">Management Consultancy</a></li>
                  <li><a href="research.php.html">Research Based Business</a></li>
                  <li><a href="investment.php.html">Investment Advisory</a></li>
                  </ul>
