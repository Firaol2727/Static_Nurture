...
<div id="wrapper" class="clearfix">
          ...
          <div class="col-md-4 pr-0">
            <div class="widget">
              <ul class="styled-icons icon-sm pull-right flip sm-pull-none sm-text-center mt-5">
                ...
                <li><a href="nurture.btc@gmail.com"><i class="fa fa-google-plus text-white"></i></a></li>
 ...
 <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark-4" data-bg-img="images/bg/download10.jpeg">
      <div class="container pt-120 pb-60">
        <!-- Section Content -->
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Investment Advisory</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="index.php.html">Home</a></li>
                <li><a href="service.php">services</a></li>
                <li class="active">Investment Advisory</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 blog-pull-right">
            <div class="single-service">
              ...
              <h3 class="text-theme-colored line-bottom text-theme-colored">Investment Advisory</h3>
              <p>We provide prefeasibility and feasibility studies in any business Startups  and investments.  

              </p>
              <blockquote class="bg-silver-light">An Investment advisory, in financial/investment organizations, is the unit linking the investment professionals in the central asset management unit (Investment Research, Portfolio Management) to the relationship managers and/or to important clients of the asset management organization. </blockquote>
            
              <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Developing Effective Investment Advisory</h4>
              <div class="row">
                <div class="col-md-6">
                    <div class="mt-20">
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star  text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Portfolio Analysis</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored2"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Investment Strategy Development</h5>
                          <p> </p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Market Research and Analysis</h5>
                          <p></p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Performance Monitoring</h5>
                          <p></p>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-star text-theme-colored"></i></a>
                        <div class="media-body">
                          <h5 class="mt-0">Financial Planning Integration</h5>
                          <p></p>
                        </div>
                      </div>
                    </div>
              ...
              <h4 class="line-bottom mt-20 mb-20 text-theme-colored">Developing Investment Advisory</h4>
              <ul id="myTab" class="nav nav-tabs boot-tabs">
                <li class="active"><a href="#small" data-toggle="tab">Set Investment Goals</a></li>
                <li><a href="#medium" data-toggle="tab">Perform Investment Research</a></li>
                <li><a href="#large" data-toggle="tab">Monitor and Review</a></li>
              ...
              <div id="myTabContent" class="tab-content bg-silver-light">
                <div class="tab-pane fade in active" id="small">
                  <div class="mt-20">
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Set Investment Goals</h5>
                        <p>
                          Begin by defining your investment goals. 
                          Consider factors such as your financial objectives, time horizon, risk tolerance, and liquidity requirements. 
                          Common investment goals include capital appreciation, income generation, wealth preservation, or a combination of these.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Assess Risk Tolerance</h5>
                        <p>
                          Evaluate your risk tolerance, which refers to your willingness and ability to withstand fluctuations in the value of your investments.
                           Assess your comfort level with risk and determine the maximum loss you are willing to tolerate.
                           This step helps in aligning your investment strategy with your risk profile.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade" id="medium">
                  <div class="mt-20">
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Conduct Market Analysis</h5>
                        <p>
                          Perform a comprehensive analysis of the financial markets and relevant asset classes.
                           Stay informed about economic trends, industry dynamics, and geopolitical factors that may impact investment opportunities. 
                           Evaluate various asset classes 
                          such as stocks, bonds, commodities, real estate, or alternative investments to identify potential areas of interest.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Diversify Your Portfolio</h5>
                        <p>
                          Diversification is a critical element of investment strategy. Allocate your investments across 
                          different asset classes, industries, geographical regions, and investment styles. Diversification helps reduce risk by
                           spreading investments across multiple sources, potentially mitigating losses from any single investment
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade" id="large">
                  <div class="mt-20">
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Select Investment Vehicles</h5>
                        <p>
                          Choose suitable investment vehicles to implement your strategy. Examples include individual stocks, bonds, 
                          mutual funds, ETFs, real estate investment trusts (REITs), 
                          or alternative investments. Select investments that align with your asset allocation, risk tolerance, and 
                  ...
                  <div>
                    <div class="left media p-0 mb-10"> <a href="#" class="pull-left flip"><i class="fa fa-2x fa-line-chart text-theme-colored"></i></a>
                      <div class="media-body">
                        <h5 class="mt-0">Monitor and Rebalance</h5>
                        <p>
                          Regularly monitor the performance of your investments and periodically rebalance your portfolio. Rebalancing 
                          involves adjusting the allocation of your investments to maintain the desired asset allocation. Market fluctuations
                           may cause your portfolio to
                           deviate from the original proportions, and rebalancing helps realign the portfolio to its intended targets
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div class="sidebar sidebar-left mt-sm-30 ml-40">
              <div class="widget">
                ...
                <div class="services-list">
                  ...
                  <li><a href="management.php.html">Management Consultancy</a></li>
                  <li><a href="research.php.html">Research Based Business</a></li>
                  <li class="active"><a href="investment.php.html">Investment Advisory</a></li>
                  </ul>
                </div>
              </div>
              <div class="widget">
              ...
              <div class="widget">
                ...
                <form id="quick_contact_form_sidebar" name="footer_quick_contact_form" class="quick-contact-form" action="http://thememascot.net/demo/personal/j/consulting-pro/v3.0/demo/includes/quickcontact.php" method="post">
